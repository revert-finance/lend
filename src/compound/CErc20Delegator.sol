...
contract CErc20Delegator is CTokenInterface, CErc20Interface, CDelegatorInterface {
    ...
    /**
     * @notice The sender liquidates the borrowers collateral Uni v3 (or parts of it).
     *  The collateral seized is transferred to the liquidator.
     * @param borrower The borrower of this cToken to be liquidated
     * @param repayAmount The amount of the underlying borrowed asset to repay
     * @param collateralTokenId The id of the collateral uni v3 position
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function liquidateBorrowUniV3(address borrower, uint repayAmount, uint256 collateralTokenId) override external returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("liquidateBorrowUniV3(address,uint256,uint256)", borrower, repayAmount, collateralTokenId));
        return abi.decode(data, (uint));
    }
