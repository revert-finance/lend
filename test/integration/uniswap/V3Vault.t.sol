...
contract MockNoopGaugeManager {
    ...
    function compoundRewards(uint256, bytes calldata, bytes calldata, uint256, uint256, uint256, address, uint256)
        external
        pure
...
contract V3VaultIntegrationTest is Test {
    ...
    function testLiquidationWithFlashloan() external {
        ...
        // FIX: Swap the order of parameters - UNIVERSAL_ROUTER and EX0x
