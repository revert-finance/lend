...
contract AutoRangeAutoCompoundTest is AutomatorIntegrationTestBase {
    AutoRange autoRange;

    function setUp() external {
        _setupBase();
        autoRange = new AutoRange(NPM, OPERATOR_ACCOUNT, WITHDRAWER_ACCOUNT, 60, 100, UNIVERSAL_ROUTER, EX0x);
    }
