...
contract DeployPolygon is Script {
    ...
    function run() external {
        ...
        InterestRateModel interestRateModel = new InterestRateModel(0, Q96 * 5 / 100, Q96 * 109 / 100, Q96 * 80 / 100);
        ...
        V3Oracle oracle = new V3Oracle(NPM, address(USDC), address(0));
        oracle.setTokenConfig(USDC, AggregatorV3Interface(0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7), 0, IUniswapV3Pool(address(0)), 0, V3Oracle.Mode.TWAP, 0);
        ...
        vault.setLimits(100000000, 100000000);
