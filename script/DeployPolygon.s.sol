...
contract DeployPolygon is Script {
    ...
    function run() external {
        ...
        InterestRateModel interestRateModel = InterestRateModel(0x7d6411cbA65Cb81F8Ff9723dA66e8aa0d58E8355);// new InterestRateModel(0, Q96 * 5 / 100, Q96 * 109 / 100, Q96 * 80 / 100);
        ...
        V3Oracle oracle = V3Oracle(0x3A22Fe0aB53478F071c66Fce166b033C35562CED);// new V3Oracle(NPM, address(USDC), address(0));
